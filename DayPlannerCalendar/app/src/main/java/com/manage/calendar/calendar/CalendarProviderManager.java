package com.manage.calendar.calendar;
...
import com.manage.calendar.Util;
...
public class CalendarProviderManager {
     ...
     */
    public static List<CalendarEvent> queryAccountEvent(Context context, long calID,long startMillis,long endMillis) {
        Util.checkContextNull(context);
...
//        ContentUris.appendId(builder, endMillis);
    ...
    public static List<CalendarEvent> queryAccountAllEvent(Context context, long calID) {
        Util.checkContextNull(context);
...
//                + " = ?) AND (" + CalendarContract.Events.DTSTART + " >= ?) AND (" + CalendarContract.Events.DTEND + " <= ?))";
    ...
    public static void startCalendarForIntentToInsert(Context context, long beginTime, long endTime,
        ...
        if (null != intent.resolveActivity(context.getPackageManager())) {
           // context.startActivity(intent);
            ((Activity)context).startActivityForResult(intent,12301);
     ...
     */
    public static void startCalendarForIntentToEdit(Context context, long eventID,long beginTime, long endTime) {
        checkCalendarAccount(context);
